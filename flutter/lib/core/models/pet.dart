...
class PetIDCard extends Equatable {
  ...
  @override
  List<Object?> get props => [id, petId, style, cartoonImageUrl, tags, description, generatedAt];
}
...
class CollectibleCard extends Equatable {
  ...
  @override
  List<Object?> get props => [id, petId, name, imageUrl, description, rarity, theme, tags, obtainedAt];
}
